...
export type ReviewWork = { id: string; title: string; description: string; cover_url: string; trial_url: string; tags: string; review_status: string; review_note: string; source_url: string; deployment_status: string; deployment_error: string; created_at: string };
